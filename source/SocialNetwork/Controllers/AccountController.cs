    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            if (Request.QueryString["guid"] != null)
                SocialNetworkSessionFacade.JoinGroupOrGoal = Request.QueryString["guid"];
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (SocialNetworkSessionFacade.JoinGroupOrGoal != null)
                    {
                        string groupOrGoalJoinToken = SocialNetworkSessionFacade.JoinGroupOrGoal;
        ...
        public ActionResult LogOff()
        {
            ...
            SocialNetworkSessionFacade.Clear();
            return RedirectToAction("Index", "Home");
        }
        ...
        public ViewResult UserProfile(string id)
        {
            ...
            userprofile.Email = userdetail.Email;
            userprofile.UserName = user.UserName;
            userprofile.DateCreated = user.DateCreated;
            userprofile.LastLoginTime = user.LastLoginTime;
            userprofile.UserId = user.Id;
            userprofile.ProfilePicUrl = user.ProfilePicUrl;
            userprofile.DateOfBirth = userdetail.DateOfBirth;
            userprofile.Gender = userdetail.Gender;
            userprofile.Address = userdetail.Address;
            userprofile.City = userdetail.City;
            userprofile.State = userdetail.State;
            userprofile.Country = userdetail.Country;
            userprofile.ZipCode = userdetail.ZipCode;
            userprofile.ContactNo = userdetail.ContactNo;

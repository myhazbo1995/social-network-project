    ...
    public class GoalController : Controller
    {
        ...
        public PartialViewResult DisplayUpdates(int id)
        {
            ...
            UpdateListViewModel updates = new UpdateListViewModel()
            {
                ...
                // IsSupported =  updateSupportService.IsUpdateSupported(,((SocialNetworkUser)(User.Identity)).UserId)
            };
                ...
                else
                {
                    updateService.CreateUpdate(update);
                     ...
                     UpdateListViewModel updates = new UpdateListViewModel()
                     {
                         ...
                         //IsSupported = updateSupportService.IsUpdateSupported(newupdate.UpdateId,((SocialNetworkUser)(User.Identity)).UserId)
                     };
                     return PartialView("_UpdateView", updates);
        ...
        public ActionResult ListOfGoals()
        {
            ...
            var returnGoals = Mapper.Map<IEnumerable<Goal>, GoalsPageViewModel>(goals);
            return View(returnGoals);
        }
        ...
        public ActionResult Goalslist(int sortby, int filter)
        {
            ...
            {
                var goals = goalService.GetGoals();
                var returnGoals = Mapper.Map<IEnumerable<Goal>, IEnumerable<GoalListViewModel>>(goals);
                return PartialView("_Goalslist", returnGoals);
            }
            else if (sortby == 0 && filter == 1)
            {

                var goal = goalService.GetGoalsofFollowing(User.Identity.GetUserId());
                var returnGoals = Mapper.Map<IEnumerable<Goal>, IEnumerable<GoalListViewModel>>(goal);
                return PartialView("_Goalslist", returnGoals);
            }
            ...
            return PartialView("_Goalslist", new List<GoalListViewModel>());
        }

...
namespace SocialNetwork.Web.Controllers
{
    ...
    public class GroupController : Controller
    {
        ...
        public ViewResult Index(int id)
        {
            ...
            //group.GroupUserId = groupUserService.GetGroupUserByuserId(((SocialNetworkUser)(User.Identity)).UserId).GroupUserId;
            group.Users = groupUserService.GetMembersOfGroup(id);
            //if (group.GroupUser.UserId == ((SocialNetworkUser)(User.Identity)).UserId)
        ...
        public ActionResult CreateGroup(GroupFormModel newGroup)
        {
            ...
            {
                //group.UserId = ((SocialNetworkUser)(User.Identity)).UserId;
                var createdGroup = groupService.CreateGroup(group, userId);
                //var createdGroup = groupService.GetGroup(newGroup.GroupName);
                //var groupAdmin = new GroupUser { GroupId = createdGroup.GroupId, UserId = ((SocialNetworkUser)(User.Identity)).UserId, Admin = true };
        ...
        public ActionResult CreateGoal(GroupGoalFormModel goal)
        {
            ...
            if (ModelState.IsValid)
            {
                //groupgoal.GroupUser.UserId = ((SocialNetworkUser)(User.Identity)).UserId;
